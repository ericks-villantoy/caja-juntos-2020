...
@Entity
@org.hibernate.annotations.NamedNativeQuery(name ="buscar_distrito_asignado", query="call SITC.PKG_ASIGNACION_PERSONAL.FILTRAR_DISTRITO(?,:P_CODIGO)",
											callable = true, resultClass = DistritoAsignado.class)
public class DistritoAsignado implements Serializable 
{

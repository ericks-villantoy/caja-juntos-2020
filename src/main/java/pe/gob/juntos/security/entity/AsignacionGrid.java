...
@Entity
@org.hibernate.annotations.NamedNativeQuery(name ="buscar_asignacion",
											query="call SITC.PKG_ASIGNACION_PERSONAL.FILTRAR_PERSONAL(?,:P_COD_USUARIO,:P_X_NOMBRES,:P_X_APPATERNO,:P_X_APMATERNO,:P_NRODNI,:P_C_REG,:P_COD_PERFIL, :P_ESTADO, :P_C_DEPA, :P_C_PROV, :P_C_DIST)",
											callable = true, resultClass = AsignacionGrid.class)
public class AsignacionGrid implements Serializable
{
